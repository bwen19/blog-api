...
func allowedRoles() map[string][]string {
	...
	return map[string][]string{
		...
		blogBasePath + "GetUserProfile":        {"anonymous", "admin", "author", "user"},
		...
		blogBasePath + "DeleteMessages":        {"admin"},
		...
		blogBasePath + "GetFeaturedPosts":      {"any"},
		blogBasePath + "GetPosts":              {"any"},
		blogBasePath + "ReadPost":              {"anonymous", "admin", "author", "user"},
		...
		blogBasePath + "ListComments":          {"anonymous", "admin", "author", "user"},
		blogBasePath + "ListReplies":           {"anonymous", "admin", "author", "user"},
